...
<div class="page-inner page-inner--offset-bottom">
  <div class="page-inner__wrapper">
    <div class="page-inner__left-col">

      <!-- Здесь уже именно моя вёрстка -->
      <link rel="stylesheet" href="./reset.css">
      <link rel="stylesheet" href="./index.css">
      <div class="ms-container">
        <article class="ms-top">
          <h3 class="ms-top__header">Юридическое<br>сопровождение<br>медицинской деятельности</h3>
        ...
        <article class="ms-help-prologue">
          <p class="ms-help-prologue__text">
            Решили получить медицинскую лицензию? Столкнулись с трудностями при ведении бизнеса? Проходите проверку
            Минздрава?
            С поддержкой «ЮКВ-Бизнес» заниматься медициной безопаснее и проще.
          </p>
        </article>
        ...
        <article class="ms-kind-of-help">
          ...
          <div class="ms-kind-of-help__columns">
            <div class="ms-kind-of-help__column">
              <ul class="ms-list">
                <li>Проводим экспертизу внутренней документации, исправляем недочеты</li>
                <li>Разрабатываем пакеты документов, необходимых для работы.</li>
                <li>Формируем ответы на претензии клиентов и партнеров</li>
                <li>Формируем ответы на запросы гос. органов</li>
              </ul>
            </div>
            <div class="ms-kind-of-help__column">
              <ul class="ms-list">
                <li>Консультируем по любым юридическим вопросам, не менее 1 часа.</li>
                <li>Помогаем с подбором персонала для лицензирования</li>
                <li>Консультируем по вопросам подбора помещения для лицензирования</li>
              </ul>
            </div>
          </div>
        </article>
        ...
        <article class="ms-licensing" id="ms-licensing">
          <div class="ms-licensing-buttons">
            ...
            <div class="ms-licensing-button ms-licensing-button_active" id="ms-licensing-button-1">
              ...
              <p class="ms-licensing-button__description">сопровождение медицинской деятельности</p>
            </div>
          ...
          <div class="ms-licensing-info" id="ms-licensing-info-1">
            ...
            <div class="ms-licensing-info__description">
              <p class="ms-licensing-info__description-text">
                От правильного выбора помещения и образования персонала зависит, как быстро вы получите лицензию.
                «ЮКВ-Бизнес» точно знает, какие специалисты должны быть в штате клиники и подберет необходимых
                сотрудников.
              </p>
              <h3 class="ms-licensing-info__description-header">Услуги:</h3>
              <div class="ms-licensing-info__description-list">
                <ul class="ms-list">
                  <li>Подбор персонала для получения лицензирования медицинской деятельности</li>
                  <li>Помощь в выборе помещения для ведения медицинской деятельности</li>
                  <li>Помощь с проектом помещения и технологического оснащения для ведения медицинской деятельности</li>
                </ul>
              </div>
            </div>
          </div>
          ...
          <div class="ms-licensing-info ms-g-hidden" id="ms-licensing-info-2">
            ...
            <div class="ms-licensing-info__description">
              <p class="ms-licensing-info__description-text">
                Чтобы избежать штрафов и лишения лицензии, важно проводить аудит медицинской деятельности. «ЮКВ-Бизнес»
                проверит ваш центр и даст свои рекомендации. С ними проверки надзорных органов не страшны.
              </p>
              <h3 class="ms-licensing-info__description-header">Услуги:</h3>
              <div class="ms-licensing-info__description-list">
                <ul class="ms-list">
                  <li>Аудит медицинской деятельности</li>
                  <li>Аудит медицинской деятельности</li>
                  <li>Помощь с проектом ремонта и технологическим оснащением организаций</li>
                </ul>
              </div>
            </div>
          </div>
        ...
        <article class="ms-documentation" id="ms-documentation">
          <h3 class="ms-documentation-header">
            Документация<br>для ведения медицинской деятельности
          </h3>

          <div class="ms-documentation-info">
            <p class="ms-documentation-info__title">Индивидуальные пакеты документов</p>
            <p class="ms-documentation-info__description">
              Грамотное ведение документации необходимо для успешного прохождения проверок. Регламентировать нужно всё
              от оформления сотрудников в штат до получения отзывов пациентов. «ЮКВ-Бизнес» избавит от волокиты и
              разработает все необходимые документы для вашего медицинского центра:
            </p>
          </div>
          ...
          <div class="ms-documents" id="ms-documents">
            ...
            <div class="ms-documents-group">
              ...
              <div class="ms-documents-group__header">
                <p class="ms-documents-group__title">Документы для оформления трудовых отношений и предотвращения
                  материального ущерба (увод клиентов, убытки)</p>
                ...
                <div class="ms-documents-group__icon">
                  <svg width="38" height="37" viewBox="0 0 38 37" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
                        d="M1.71348 18.5C1.71348 8.83445 9.54412 1 19.2024 1C28.8608 1 36.6914 8.83445 36.6914 18.5C36.6914 28.1655 28.8608 36 19.2024 36C9.54412 36 1.71348 28.1655 1.71348 18.5Z"
                        stroke="black" stroke-width="2"/>
                    <path d="M29.4736 22.6111L19.202 13.3611L8.93034 22.6111" stroke="black" stroke-width="2"
              ...
              <div class="ms-document-group__documents-container">
                ...
                <div class="ms-document-group__document">
                  <p class="ms-document-group__document-title">Комплекты кадровой документации (положения, приказы,
                    формы, планы, распоряжения, бланки — более 50 видов)</p>
        ...
        <div class="licens_dop_registration">
          <h3 class="ti">Вместе с юридическим сопровождением оформляют</h3>
          <ul class="licens_dop_registration__list">
            <li>
              <a class="npl_block_blue btn_str_hover_main" href="licensing/">
            ...
            <li>
              <a class="npl_block_blue btn_str_hover_main" href="#">
                <div class="npl_block_blue__name">
    ...
    <div class="page-inner__right-col">
