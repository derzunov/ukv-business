...
<div class="ms-container">
  ...
  <article class="ms-help-prologue">
    <p class="ms-help-prologue__text">
      Решили получить медицинскую лицензию? Столкнулись с трудностями при ведении бизнеса? Проходите проверку Минздрава?
  ...
  <article class="ms-licensing" id="ms-licensing">
    ...
    <div class="ms-licensing-info" id="ms-licensing-info-1">
      ...
      <div class="ms-licensing-info__description">
        <p class="ms-licensing-info__description-text">
          От правильного выбора помещения и образования персонала зависит, как быстро вы получите лицензию. «ЮКВ-Бизнес» точно знает, какие специалисты должны быть в штате клиники и подберет необходимых сотрудников.
        </p>
    ...
    <div class="ms-licensing-info ms-g-hidden" id="ms-licensing-info-2">
      ...
      <div class="ms-licensing-info__description">
        <p class="ms-licensing-info__description-text">
          Чтобы избежать штрафов и лишения лицензии, важно проводить аудит медицинской деятельности. «ЮКВ-Бизнес» проверит ваш центр и даст свои рекомендации. С ними проверки надзорных органов не страшны.
        </p>
        <h3 class="ms-licensing-info__description-header">Услуги:</h3>
        <div class="ms-licensing-info__description-list">
          <ul class="ms-list">
  ...
  <article class="ms-documentation" id="ms-documentation">
    ...
    <div class="ms-documentation-info">
      ...
      <p class="ms-documentation-info__description">
        Грамотное ведение документации необходимо для успешного прохождения проверок. Регламентировать нужно всё от оформления сотрудников в штат до получения отзывов пациентов. «ЮКВ-Бизнес» избавит от волокиты и разработает все необходимые документы для вашего медицинского центра:
      </p>
    </div>
...
<script src="main.js?foo=ba"></script>
